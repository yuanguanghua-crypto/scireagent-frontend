    ...
    export default {
        ...
        methods: {
            ...
            appendWarning(msgParam) {
                console.log('--推送---智能设备告警-----------',msgParam);
                if(msgParam.eventSource && msgParam.eventSource.sourceCodeType == 'intelligent_device'){
                    let msgParams = {}
