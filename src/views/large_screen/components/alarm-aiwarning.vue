...
import { aiAlarmAllTable,queryEventSource } from '@/api/v3/largeScreen/set.js';
...
export default {
    ...
    data() {
        return {
            ...
            sourceCode: ['intelligent_device','bright_kitchen','safe_production']
        };
    },
    watch: {},
    created() {
    ...
    methods: {
        ...
        appendWarning(msgParam) {
            if(msgParam.eventSource && this.sourceCode.includes(msgParam.eventSource.sourceCodeType)){
                let msgParams = {}
