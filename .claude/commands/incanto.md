...
3. **Additionally gather**: what's appropriate for the domain (playful vs professional vs quirky vs elegant) — ask the user if unclear.
...
**Sound libraries**: Howler.js (audio management), Use-sound (React hook)
